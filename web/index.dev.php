...
$sc->setParameter('twig_cache', false);
$sc->setParameter('twig_debug', true);

$sc->setParameter('exceptionHandler', 'QuickBetOnline\Controllers\DevErrorController::exceptionAction');
